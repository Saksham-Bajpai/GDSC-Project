...
const categoryList = [womenDress,womenClothing,campAccess,automobile,kidsToys,sports,jewelery,cellphone,furniture];
...
const profileButtonsList = [icOrder,icOrders,icMessages];
